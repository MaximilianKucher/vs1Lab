...
var gtaLocator = (function GtaLocator() {
    ...
    return { // Start öffentlicher Teil des Moduls ...
        ...
        update: function () {
            ...
            /**Funktion soll latitude und longitude Eingabefelder des Tagging-Formulars 
             * und des Discovery-Formulars (versteckte Eingabefelder) suchen und in 
             * deren value-Attribute Koordinaten schreiben.
             */
            function success(position) {
                $("#latitude").attr("value", getLatitude(position));
                $("#longitude").attr("value", getLongitude(position));
                $("#hiddenlatitude").attr("value", getLatitude(position));
                $("#hiddenlongitude").attr("value", getLongitude(position));
            }
